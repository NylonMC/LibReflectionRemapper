...
//
package io.github.nylonmc.libreflectionremapper.org.msgpack.core;

import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBuffer;
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferOutput;
...
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.ARRAY16;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.ARRAY32;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.BIN16;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.BIN32;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.BIN8;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.EXT16;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.EXT32;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.EXT8;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FALSE;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FIXARRAY_PREFIX;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FIXEXT1;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FIXEXT16;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FIXEXT2;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FIXEXT4;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FIXEXT8;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FIXMAP_PREFIX;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FIXSTR_PREFIX;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FLOAT32;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.FLOAT64;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.INT16;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.INT32;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.INT64;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.INT8;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.MAP16;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.MAP32;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.NIL;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.STR16;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.STR32;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.STR8;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.TRUE;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.UINT16;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.UINT32;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.UINT64;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePack.Code.UINT8;
import static io.github.nylonmc.libreflectionremapper.org.msgpack.core.Preconditions.checkNotNull;
        ...
        implements Closeable, Flushable
{
    ...
    /**
     * Create an MessagePacker that outputs the packed data to the given {@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferOutput}.
     ...
     *
     * @param out MessageBufferOutput. Use {@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.OutputStreamBufferOutput}, {@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.ChannelBufferOutput} or
     * your own implementation of {@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferOutput} interface.
     */
    ...
    private void prepareEncoder()
    {
        if (encoder == null) {
             ...
             *
             * io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessageStringCodingException: java.nio.charset.MalformedInputException: Input length = 1
             *     at io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePacker.encodeStringToBufferAt(MessagePacker.java:467) ~[msgpack-core-0.8.6.jar:na]
             *     at io.github.nylonmc.libreflectionremapper.org.msgpack.core.MessagePacker.packString(MessagePacker.java:535) ~[msgpack-core-0.8.6.jar:na]
             *

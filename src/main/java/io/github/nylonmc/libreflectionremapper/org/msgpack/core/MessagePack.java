...
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.ArrayBufferInput;
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.ByteBufferInput;
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.ChannelBufferInput;
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.ChannelBufferOutput;
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.InputStreamBufferInput;
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferInput;
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferOutput;
import io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.OutputStreamBufferOutput;
 ...
 *   <tr><td>{@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferInput}</td><td>{@link #newDefaultUnpacker(MessageBufferInput)}</td><td>{@link MessageUnpacker}</td></tr>
 * </table>
 *
 * <p>
 ...
 *   <tr><td>{@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferOutput}</td><td>{@link #newDefaultPacker(MessageBufferOutput)}</td><td>{@link MessagePacker}</td></tr>
 * </table>
 *
 */
public class MessagePack
{
     ...
     * <p>
     * {@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferOutput} is an interface that lets applications customize memory
     ...
     * <p>
     * {@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferInput} is an interface that lets applications customize memory
            ...
            implements Cloneable
    {
         ...
         * {@link io.github.nylonmc.libreflectionremapper.org.msgpack.core.buffer.MessageBufferOutput#flush()} before writing more data (default: 8192).
         */
